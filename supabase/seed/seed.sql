...
insert into public.documents (id, school_id, folder_id, title, storage_path, audience, target_ids, requires_signature, signature_per_student, published_at, created_by, purpose) values
  (pg_temp.uid('0', 2816 + 1), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 1), 'Règlement intérieur 2026-2027 (démo)', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b01/reglement.pdf', 'school', '{}', true, false, now() - interval '20 days', pg_temp.uid('a', 1), 'charter'),
  (pg_temp.uid('0', 2816 + 2), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 5), 'Droit à l''image 2026-2027', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b02/droit-image.pdf', 'school', '{}', true, true, now() - interval '20 days', pg_temp.uid('a', 1), 'image_rights'),
  (pg_temp.uid('0', 2816 + 3), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 5), 'Autorisation de sortie : jardin pédagogique (PS)', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b03/sortie-jardin.pdf', 'level', array[pg_temp.uid('0', 256 + 2)], true, true, now() - interval '6 days', pg_temp.uid('a', 2), 'outing_authorization'),
  (pg_temp.uid('0', 2816 + 4), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 5), 'Autorisation de sortie : musée (CE1)', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b04/sortie-musee.pdf', 'class', array[pg_temp.uid('0', 512 + 6)], true, true, now() - interval '6 days', pg_temp.uid('a', 2), 'outing_authorization'),
  (pg_temp.uid('0', 2816 + 5), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 3), 'Menus de septembre', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b05/menus-09.pdf', 'school', '{}', false, false, now() - interval '5 days', pg_temp.uid('a', 2), 'generic'),
  (pg_temp.uid('0', 2816 + 6), pg_temp.uid('0', 1), pg_temp.uid('0', 2560 + 4), 'Liste de fournitures CP', '00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000b06/fournitures-cp.pdf', 'level', array[pg_temp.uid('0', 256 + 5)], false, false, now() - interval '25 days', pg_temp.uid('a', 2), 'generic');
