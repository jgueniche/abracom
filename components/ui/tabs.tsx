  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-card data-active:text-foreground data-active:shadow-soft data-active:ring-1 data-active:ring-border/70 dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
