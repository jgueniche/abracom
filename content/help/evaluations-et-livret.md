---
title: Les évaluations par compétences et le livret
roles: [parent, teacher, school_admin, super_admin]
routes: [/classes/[classId]/evaluations]
topic: daily
...
:::roles parent
Vous voyez les compétences d'une période une fois qu'elles ont été **publiées** par l'enseignant·e : avant cela, rien n'apparaît. L'appréciation de l'enseignant·e accompagne la grille, et le **livret en PDF** se télécharge depuis la même page.
:::
